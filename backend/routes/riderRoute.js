...
import {  getAllRiders,
  ...
  riderEarningByRange,getAllRidersOrder,getOrderStatusCounts,getOnlineTotalRider,submitRiderCOD,getRiderCODamount,createRiderCODOrder,
    verifyRiderCODPayment, getRiderCODHistory
...
riderRouter.get('/riderCODHistory', restrictToRoles("rider" ,"admin"), getRiderCODHistory);
...
riderRouter.post('/createRiderCODOrder', restrictToRoles("rider"), createRiderCODOrder); // Assuming this is for creating a COD order by the rider
riderRouter.post('/verifyRiderCODPayment', restrictToRoles("rider"), verifyRiderCODPayment); // Assuming this is for verifying the COD payment by the rider
