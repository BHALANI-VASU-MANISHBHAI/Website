        ...
        <div className="relative">
          <img
            ...
            className={`cursor-pointer rounded-full ${
              userData.profilePhoto ? "w-7 h-7" : "w-5 h-5"
            }`}
          />
      ...
      >
        <div className="flex flex-col gap-5 p-4">
          ...
          <NavLink
            ...
            onClick={() => setVisible(false)}
            className={({ isActive }) =>
              `py-2 pl-6 border rounded-md transition-colors duration-200 ${
                isActive
          ...
          {token && (
            <>
              ...
              <p
                className="py-2 pl-6 border rounded-md text-red-500 hover:bg-red-100 cursor-pointer"
                onClick={() => {
                  logout();
                  setVisible(false);
                }}
