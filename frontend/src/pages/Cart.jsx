          ...
          return (
            ...
            >
                ...
                <div>
                  ...
                  <div className="flex items-center gap-5 mt-2">
                    <p className="">
                      ...
                      <span
                        className={`${
                          ProductData.discount > 0 ? "line-through" : ""
                        }`}
                      >
                        {" "}
              ...
              <input
                ...
                min={1}
                max={
                  ProductData.stock.find((s) => s.size === item.size)
                    ?.quantity || 1
                }
                value={item.quantity}
                onChange={(e) => {
                  ...
                  const maxQuantity = stockItem?.quantity || 1;

                  if (isNaN(val) || val < 1 || val > maxQuantity) return;
